...
#import "UIActionSheet+AJBlockAdditions.h"
...
@implementation UIActionSheet (AJBlockAdditions)
                     ...
                     onCancel:(CancelBlock) cancelled
{
    ...
    [actionSheet addButtonWithTitle:AMLocalizedString(@"Cancel", @"")];
                     ...
                     onCancel:(CancelBlock) cancelled
{
	...
	{
		[actionSheet addButtonWithTitle:AMLocalizedString(@"Camera", @"")];
		cancelButtonIndex ++;
	}
	if([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypePhotoLibrary])
	{
		[actionSheet addButtonWithTitle:AMLocalizedString(@"Photo library", @"")];
		cancelButtonIndex ++;
	}
