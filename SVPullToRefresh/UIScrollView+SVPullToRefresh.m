...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:AMLocalizedString(@"Pull to refresh...",nil),
                                                       AMLocalizedString(@"Release to refresh...",nil),
                                                       AMLocalizedString(@"Loading...",nil),
                                                       nil];
...
- (UILabel *)titleLabel {
    if(!_titleLabel) {
        ...
        _titleLabel.text = AMLocalizedString(@"Pull to refresh...",nil);
...
- (void)setLastUpdatedDate:(NSDate *)newLastUpdatedDate {
    ...
    self.dateLabel.text = [NSString stringWithFormat:AMLocalizedString(@"Last Updated: %@",nil), newLastUpdatedDate?[self.dateFormatter stringFromDate:newLastUpdatedDate]:AMLocalizedString(@"Never",nil)];
}

- (void)setDateFormatter:(NSDateFormatter *)newDateFormatter {
	dateFormatter = newDateFormatter;
    self.dateLabel.text = [NSString stringWithFormat:AMLocalizedString(@"Last Updated: %@",nil), self.lastUpdatedDate?[newDateFormatter stringFromDate:self.lastUpdatedDate]:AMLocalizedString(@"Never",nil)];
}
